...
## Apresentation
Welcome, this project is our the Course Conclusion Work <a href="https://pt.wikipedia.org/wiki/Trabalho_de_conclus%C3%A3o_de_curso"> (TCC) </a> of the technical course of Development of systems of SENAI Suiço-Brasileira Paulo Ernesto Tolle school.
...
## About the project
This application was requested by the coordinator of the SENAI Suiço-Brasileira Paulo Ernesto Tolle school, in order to control the prints made by the different sectors of the school (teachers, employees, etc.), thus being able to better manage expenses and waste.
