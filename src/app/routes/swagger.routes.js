...
const swaggerDocsV1 = require("../../swagger/v1/swaggerV1.config.json");
const swaggerDocsV2 = require("../../swagger/v2/swaggerV2.config.json");
const swaggerDocsV3 = require("../../swagger/v3/swaggerV3.config.json");
