...
<body class="">
    <span class="preheader">Foi solicitado o seguinte pedido:</span>
        ...
        <tr>
            ...
            <td class="container">
                <div class="content">
                    ...
                    <table role="presentation" class="main">
                        ...
                        <tr>
                            <td class="wrapper">
                                <img class="imgLogo"
                                    src="https://logodownload.org/wp-content/uploads/2019/08/senai-logo-2.png"></img>
                                <h2></h2>
                ...
                <div>
                    ...
                    <div class="flex">
                        <h4 class="servicos" id="servicoCT">Tipo da cópia e Tamanho:<p>${servicoCT}</p>
                        </h4>
                        <h4 class="servicos">Capa e acabamento: <p>${servicoCA}</p>
                        </h4>
                    </div>
                </div>
    ...
    <br>
    <p>Caso identifique algum problema com essa solicitação, por favor <span id="span">nos contate</span>!</p>
    <p>Atenciosamente, Equipe SENAI Suíço-Brasileira Paulo Ernesto Tolle.</p>
    </td>
    </tr>
    </table>
    </td>
        ...
        <table role="presentation" border="0" cellpadding="0" cellspacing="0">
            <tr>
                <td class="content-block">
                    <span class="apple-link">Rua Bento Branco de Andrade Filho, 379 - Santo Amaro
                    </span>
                    <br> São Paulo/SP - CEP 04757-000</a>.
                </td>
            </tr>
            <tr>
